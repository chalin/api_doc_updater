...
import 'api_doc_updater.dart';
import 'package:args/args.dart';

const _commandName = 'api_doc_updater';

/// Processes `.dart` files, and recursively traverses directories looking for
/// `.dart` files, using a [ApiDocUpdater]. See this commands help for CLI
/// argument details.
class ApiDocUpdaterCLI {
  ...
  Future _updateFile(String filePath) async {
    final updater = new ApiDocUpdater(fragmentPathPrefix);
